<template>
    <div class="events">
        <div class="container my-container">
            ...
            <Event class="event-item" image="smores.jpg" title="Smores Night with JC and ISA" description="Come through to eat s'mores and meet members of other CIOs!" month="Nov" day="10" time="7pm" location="Lawn Room 25"></Event>
